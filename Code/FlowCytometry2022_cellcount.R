...
setwd("C:/Users/lenovo/Desktop/Imperial/EEC Summer Project/Data/flow-cytometry/Flow-cytometryMay17")

# list of flow cytometry folders (within /data/ folder):
folder_list <- c("20220517_1_6", "20220517_7_12")
